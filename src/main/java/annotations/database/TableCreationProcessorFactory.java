...
public class TableCreationProcessorFactory /*
    ...
    // }
    //
    // private static class TableCreationProcessor implements
    // AnnotationProcessor {
    ...
    // typeDecl.accept(getDeclarationScanner(new TableCreationVisitor(),
    // NO_OP));
    ...
    // if (dbTable != null) {
    // sql += "CREATE TABLE ";
    // sql += (dbTable.name().length() < 1) ? d.getSimpleName().toUpperCase() :
    // dbTable.name();
    // sql += " (";
    // }
    // }
